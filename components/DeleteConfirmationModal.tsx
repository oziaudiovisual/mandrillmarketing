...
export const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({ 
  ...
  return createPortal(
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 pt-24 animate-fadeIn">
      <div className="bg-[#171918] w-full max-w-md rounded-[5px] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        <div className="p-6 text-center">
          ...
          <h3 className="text-xl font-bold text-[#E3E3E3] mb-2">Excluir Vídeo?</h3>
          <p className="text-[#C4C7C5] text-sm mb-6 leading-relaxed">
            Você tem certeza que deseja remover <strong className="text-white">"{title}"</strong>?<br/>
            Esta ação não pode ser desfeita e removerá o arquivo do armazenamento permanentemente.
          </p>
